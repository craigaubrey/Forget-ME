...
public class QuitButton : MonoBehaviour {
	...
	private void OnGUI () {
		if(GUI.Button (new Rect(Screen.width /8 , Screen.height *9 /11 , texture.width, texture.height), currentTexture,GUIStyle.none)) {
	...
	public void Update() {
		Rect boundingBox=new Rect(Screen.width /8 , Screen.height *9 /11 , currentTexture.width, currentTexture.height);
